	...
	<aside id="sidebar">
		...
		<ul id="main-menu" class="main-menu">
			...
			<ul>
				...
				<li><a class="waves-effect" href="javascript:Tab.addTab('用户管理', '${pageContext.request.contextPath}/common/user/manage');">用户管理</a></li>
				<li><a class="waves-effect" href="javascript:Tab.addTab('产品管理', '${pageContext.request.contextPath}/demo/product/init');">产品管理</a></li>
			</ul>
			</li>
			<li class="sub-menu system_menus">
			<a class="waves-effect" href="javascript:;"><i class="zmdi zmdi-menu"></i> 集群服务器</a>
			<ul>
				<li><a class="waves-effect" href="javascript:Tab.addTab('服务器列表', '/manage/role/index');">集群服务器列表</a></li>
				<li><a class="waves-effect" href="javascript:Tab.addTab('集群配置', '${pageContext.request.contextPath}/common/user/init');">服务器状态</a></li>
				<li><a class="waves-effect" href="javascript:Tab.addTab('服务器状态', '${pageContext.request.contextPath}/common/user/init');">服务器状态</a></li>
				<li><a class="waves-effect" href="javascript:Tab.addTab('服务器配置', '${pageContext.request.contextPath}/demo/product/init');">集群配置</a></li>
			...
			<ul>
				<li><a class="waves-effect" href="javascript:Tab.addTab('权限管理', '/manage/resources/index');">系统权限管理</a></li>
				<li><a class="waves-effect" href="javascript:Tab.addTab('菜单管理', '${pageContext.request.contextPath}/common/menu/init');">集群资源管理</a></li>
				<li><a class="waves-effect" href="javascript:Tab.addTab('菜单管理', '${pageContext.request.contextPath}/common/menu/init');">服务资器源管理</a></li>
			</ul>
			</li>
			<li class="sub-menu system_menus">
			<a class="waves-effect" href="javascript:;"><i class="zmdi zmdi-settings"></i> 任务管理</a>
			<ul>
				<li><a class="waves-effect" href="javascript:Tab.addTab('日志记录', '${pageContext.request.contextPath}/common/logging/init');">脚本任务</a></li>
				<li><a class="waves-effect" href="javascript:Tab.addTab('日志记录', '${pageContext.request.contextPath}/common/logging/init');">MR任务</a></li>
				<li><a class="waves-effect" href="javascript:Tab.addTab('模板查看', '${pageContext.request.contextPath}/template');"></a>hive任务</li>
				<li><a class="waves-effect" href="javascript:Tab.addTab('模板查看', '${pageContext.request.contextPath}/template');">历史任务查看</a></li>
			</ul>
			</li>
			<li>
			
			<li class="sub-menu system_menus">
			<a class="waves-effect" href="javascript:;"><i class="zmdi zmdi-more"></i> 日志管理</a>
			<ul>
				<li><a class="waves-effect" href="javascript:Tab.addTab('日志记录', '${pageContext.request.contextPath}/common/logging/init');">系统日志</a></li>
				<li><a class="waves-effect" href="javascript:Tab.addTab('模板查看', '${pageContext.request.contextPath}/template');">服务器日志</a></li>
				<li><a class="waves-effect" href="javascript:Tab.addTab('模板查看', '${pageContext.request.contextPath}/template');">集群日志</a></li>
			</ul>
			</li>
			<li>
			
			</li>
			 <li><div class='upms-version'>&copy; lolipop FRAME V1.0</div></li>
		</ul>
		<!-- /菜单区 -->
	</aside>
	<!-- /左侧导航区 -->
...
//				
//			});
//			menuHtml += "<li><div class='upms-version'>&copy; Lolipop FRAME V1.0</div></li>";
