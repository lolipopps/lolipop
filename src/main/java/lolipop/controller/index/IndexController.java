...
package lolipop.controller.index;

import lolipop.core.annotation.LogInject;
import lolipop.core.annotation.MapperInject;
import lolipop.domain.DelegateMapper;
import lolipop.model.index.MenuModel;
...
public class IndexController extends BaseController {
    ...
    public List<MenuModel> menu(@PathVariable String roleId) {
        if ("admin".equals(this.getSessionUser().getUserType())) {
            ...
            List<MenuModel> rootList = delegateMapper.selectList("mapper.index.IndexCustomMapper.getMenu", paramMap);
    ...
    private List<MenuModel> getMenu(String pid, String roleId) {
        ...
        List<MenuModel> list = new ArrayList<>();
        List<MenuModel> menuList = delegateMapper.selectList("lolipop.api.mapper.index.IndexCustomMapper.getMenu", paramMap);
